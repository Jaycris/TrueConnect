                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <ul class="flex items-center gap-2">
                                    <li>
                                        <a href="{{ route('admin.department.edit', $department->id) }}" x-tooltip="Edit">
                                    ...
                                    <li>
                                    <button class="delete-department-btn bg-transparent border-none p-0 m-0" data-id="{{ $department->id }}" x-tooltip="Delete">
