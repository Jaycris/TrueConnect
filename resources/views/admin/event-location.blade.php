...
<div>
    ...
    <div class="panel mt-6">
        <div class="mb-5 flex items-center justify-between">
            <h5 class="text-lg font-semibold dark:text-white-light">Event Location</h5>
            <a href="{{ route('admin.package-sold.create') }}" class="btn btn-primary">Add Event Location</a>
        </div>
        @if(session('success'))
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Los Angeles Times Festival of Books</td>
                            <td class="text-center">
                                <ul class="flex items-center gap-2">
                                    ...
                                    <li>
                                    <button class="delete-department-btn bg-transparent border-none p-0 m-0" data-id="" x-tooltip="Delete">
