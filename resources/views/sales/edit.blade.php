    ...
    <div>
        ...
        <div class="pt-5">
            <div class="mb-5 flex items-center justify-between">
                <h5 class="text-lg font-semibold dark:text-white-light">Edit Endorsement</h5>
            </div>
        ...
        <div class="mt-6"></div> <!-- space -->
            <div class="mb-5">
                <form id="multi-step-form" action="" method="POST" enctype="multipart/form-data" class="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-[#0e1726]">
                    @csrf
                    @method('PUT')
                    <h6 class="mb-5 text-lg font-bold">Sales Information</h6>
                    <div class="flex flex-col sm:flex-row">
                        <label for="transaction_ID" class="mt-2">Transaction ID:</label>
                        <h1 class="mb-5 text-2xl font-normal px-2">{{ $sale->transaction_id }}</h1>
                        ...
                        <div class="flex flex-col sm:flex-row">
                            <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input id="date_sold" name="date_sold" type="text" class="form-input" data-date-format="Y-m-d" value="{{ old('date_sold', $sale->date_sold) }}" required>
                                    @error('date_sold') <p class="text-danger italic">{{ $message }}</p> @enderror
                                </div>
                                <div>
                                    <label for="consultantName">Consultant Name <span class="text-danger">*</span></label>
                                    <input id="consultantName" name="consultant_name" type="text" class="form-input" value="{{ old('consultant_name', $sale->consultant_name) }}" readonly required>
                                    @error('consultant_name') <p class="text-danger italic">{{ $message }}</p> @enderror
                                </div>
                                <div style="position: relative;">
                                    <label for="authorsName">Author's Name <span class="text-danger">*</span></label>
                                    <input id="authorsName" name="authors_name" type="text" list="authorsList" placeholder="Enter Author's Name" class="form-input" value="{{ old('authors_name',  $sale->author_name) }}" required>
                                ...
                                <div>
                                    ...
                                    <select id="gender" name="gender" class="form-select" required>
                                        <option value="Male" {{ old('gender', $sale->gender) == 'Male' ? 'selected' : '' }}>Male</option>
                                        <option value="Female" {{ old('gender', $sale->gender) == 'Female' ? 'selected' : '' }}>Female</option>
                                    </select>
                                ...
                                <div style="position: relative;">
                                    ...
                                    <input id="BookTitle" name="book_title" type="text" placeholder="Enter Book Title" value="{{ old('book_title', $sale->book_title) }}" class="form-input" autocomplete="off" required>
                                ...
                                <div>
                                    ...
                                    <input id="contact" name="contact_number" type="contact_number" placeholder="Enter Contact Number" class="form-input" value="{{ old('contact_number', $sale->contact_number) }}" required>
                                    <p class="text-red-500 text-sm hidden">This field is required</p> <!-- Hidden by default -->
                                ...
                                <div>
                                    ...
                                    <input id="email" name="email" type="email" placeholder="Enter Email Address" class="form-input" value="{{ old('email', $sale->email) }}" required>
                                    <p class="text-red-500 text-sm hidden">This field is required</p> <!-- Hidden by default -->
                                    @error('email')
                                        <p class="text-danger 500 italic">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input id="address" name="mailing_address" type="text" placeholder="Enter Mailing Address" class="form-input" value="{{ old('mailing_address', $sale->mailing_address) }}" required>
                                    <p class="text-red-500 text-sm hidden">This field is required</p> <!-- Hidden by default -->
