            ...
            <div class="flex flex-col sm:flex-row justify-center items-center w-full">
                ...
                <div class="w-full sm:w-1/2 flex flex-col items-center">
                    <div class="text-left w-full">
                        <h2 class="text-3xl font-bold">Package Type</h2>
                    </div>
                        ...
                        <div class="w-full sm:w-1/2 px-1">
                            <ul class="space-y-4">
                                <li class="flex items-center gap-2">
                                    <p><strong>Package Type Name:</strong> {{ $packType->pack_type_name }}</p>
                                </li>
                                <li class="flex items-center gap-2">
                                    <p><strong>Date added:</strong> {{ $packType->created_at->format('M d, Y') }}</p>
                                </li>
                            </ul>
                        </div>
                    </div>
