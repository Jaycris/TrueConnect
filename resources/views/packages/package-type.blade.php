...
<div>
    ...
    <div class="panel mt-6">
        <div class="mb-5 flex items-center justify-between">
            ...
            <a href="{{ route('pack-type.create') }}" class="btn btn-primary">Add Package</a>
        </div>
        @if(session('success'))
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <ul class="flex items-center gap-2">
                                    ...
                                    <li>
                                    <button class="delete-department-btn bg-transparent border-none p-0 m-0" data-id="{{ $packTypes->id }}" x-tooltip="Delete">
